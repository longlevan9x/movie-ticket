        ...
        if(strlen($token) != 0)
        {
            ...
            if (isset($login_token)){
                if(isset ($login_token->user)){
                    ...
                    //$login_token->delete();
                    return FApi::getOutputForCustomAPI('', FConstant::ERROR, FApi::getErrorMsg(221), ['code' => 221]);
                }
            }
            else{
                return FApi::getOutputForCustomAPI('', FConstant::ERROR, FConstant::TOKEN_MISMATCH, ['code' => 205]);
            }
        }
        else
        {
            return FApi::getOutputForCustomAPI('', FConstant::ERROR, 'Token missing', ['code' => 204]);
        }
    }
}
