...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cinema_brand', 'cinema_brand', 'type'),
FHtml::buildBulkActionsMenu('', 'cinema_brand', 'cinema_brand', 'status'),
FHtml::buildBulkActionsMenu('', 'cinema_brand', 'cinema_brand', 'is_active'),
