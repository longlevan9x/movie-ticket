...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cinema_hall', 'cinema_hall', 'status'),
FHtml::buildBulkActionsMenu('', 'cinema_hall', 'cinema_hall', 'is_active'),
FHtml::buildBulkActionsMenu('', 'cinema_hall', 'cinema_hall', 'type'),
