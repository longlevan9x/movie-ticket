...
'country'     => ['value' => $form->fieldNoLabel($model, 'country')->select(FHtml::getComboArray('select * from country', '', '', true, 'name', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
