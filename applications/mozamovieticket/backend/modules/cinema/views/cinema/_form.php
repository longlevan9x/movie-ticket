                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        'brand_id' => ['value' => $form->fieldNoLabel($model, 'brand_id')->select(FHtml::getComboArray('cinema', 'cinema', 'brand_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
...
'city' => ['value' => $form->fieldNoLabel($model, 'city')->select(FHtml::getComboArray('cinema', 'cinema', 'city', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'country' => ['value' => $form->fieldNoLabel($model, 'country')->select(FHtml::getComboArray('cinema', 'cinema', 'country', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        -->
                                            ...
                                            'type' => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('cinema', 'cinema', 'type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'status' => ['value' => $form->fieldNoLabel($model, 'status')->select(FHtml::getComboArray('cinema', 'cinema', 'status', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
