...
/*
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'cinema', 'id','int(11)','cinema') . '</b>' ; }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: brand_id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        'class' => FHtml::getColumnClass($object_type, 'brand_id', $form_type),
        'format'=>'raw',
        'attribute'=>'brand_id',
        'visible' => FHtml::isVisibleInGrid($object_type, 'brand_id', $form_type),
        'value' => function($model) { return FHtml::showContent($model->brand_id, FHtml::SHOW_LABEL, 'cinema', 'brand_id','int(11)','cinema'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        ...
        'filter'=> FHtml::getComboArray('cinema', 'cinema', 'brand_id', true, 'id', 'name'),
        'contentOptions'=>['class'=>'col-md-1 nowrap'],
        'editableOptions'=> function ($model, $key, $index, $widget) {
                                    $fields = FHtml::getComboArray('cinema', 'cinema', 'brand_id', true, 'id', 'name');
                                    return [
    ...
    [ //name: image, dbType: varchar(300), phpType: string, size: 300, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showImageThumbnail($model-> image, FHtml::config(FHtml::SETTINGS_THUMBNAIL_SIZE, 50), 'cinema'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
        'editableOptions'=>[                       
    ...
    //[ //name: content, dbType: text, phpType: string, size: , allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> content, '', 'cinema', 'content','text','cinema'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'contentOptions'=>['class'=>'col-md-1 nowrap'],
    //],
    ...
    [ //name: address, dbType: varchar(255), phpType: string, size: 255, allowNull:  
    ...
    [ //name: city, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('cinema', 'cinema', 'city', true, 'id', 'name'),
        'contentOptions'=>['class'=>'col-md-1 nowrap'],
        'editableOptions'=> function ($model, $key, $index, $widget) {
                                    $fields = FHtml::getComboArray('cinema', 'cinema', 'city', true, 'id', 'name');
                                    return [
                                    'inputType' => 'dropDownList',
                                    'displayValueConfig' => $fields,
                                    'data' => $fields
    ...
    //[ //name: country, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('cinema', 'cinema', 'country', true, 'id', 'name'),
        //'contentOptions'=>['class'=>'col-md-1 nowrap'],
        //'editableOptions'=> function ($model, $key, $index, $widget) {
                                    //$fields = FHtml::getComboArray('cinema', 'cinema', 'country', true, 'id', 'name');
                                    //return [
                                    //'inputType' => 'dropDownList',
                                    //'displayValueConfig' => $fields,
                                    //'data' => $fields
    ...
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model-> type, FHtml::SHOW_LABEL, 'cinema', 'type','varchar(100)','cinema'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('cinema', 'cinema', 'type', true, 'id', 'name'),
    ],
    [ //name: status, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> status, FHtml::SHOW_LABEL, 'cinema', 'status','varchar(100)','cinema'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('cinema', 'cinema', 'status', true, 'id', 'name'),
    ],
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_active, FHtml::SHOW_BOOLEAN, 'cinema', 'is_active','tinyint(1)','cinema'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
    //[ //name: sort_order, dbType: int(11), phpType: integer, size: 11, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> sort_order, FHtml::SHOW_NUMBER, 'cinema', 'sort_order','int(11)','cinema'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
