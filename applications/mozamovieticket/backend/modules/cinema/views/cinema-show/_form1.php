    ...
    <div class="row">
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                               <?= $form->field($model, 'cinema_id')->select(FHtml::getComboArray('@cinema', 'cinema', 'cinema_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'hall_id')->select(FHtml::getComboArray('@cinema_hall', 'cinema_hall', 'hall_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'movie_id')->select(FHtml::getComboArray('@cinema_movie', 'cinema_movie', 'movie_id', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'end_date')->date() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('cinema_show', 'cinema_show', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'status')->select(FHtml::getComboArray('cinema_show', 'cinema_show', 'status', true, 'id', 'name'))->labelSpan(6) ?>
