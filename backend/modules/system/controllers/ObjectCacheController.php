        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($model->load($request->post())) {
                ...
                if ($model->save()) {
                    FHtml::saveModel($modelMeta, $request->post(), ['object_cache_id' => $model->id]);

                    $files = FHtml::getUploadedFiles($model, $uploadFields, 'object-cache' . FHtml::getAttribute($model, 'id'), $oldModel);

                    FHtml::saveFiles($files, $this->uploadFolder . '/object-cache/', $model);
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($model->load($request->post())) {
                ...
                if ($model->save()) {
                    FHtml::saveFiles($files, $this->uploadFolder . '/object-cache/');
                    FHtml::saveModel($modelMeta, $request->post(), ['object_cache_id' => $model->id]);
                    FHtml::saveObjectItems($model, $this->moduleKey, $model->id, $model::getRelatedObjects());
                    if ($this->saveType() == 'clone') {
