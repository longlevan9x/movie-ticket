            ...
            */
            ...
            if ($model->load($request->post())) {
                ...
                if ($model->save()) {
                    ...
                    $files = FHtml::getUploadedFiles($model, $uploadFields, 'object-file' . FHtml::getAttribute($model, 'id'), $oldModel);

                    FHtml::saveFiles($files, $this->uploadFolder . '/object-file/', $model);
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($model->load($request->post())) {
                ...
                if ($model->save()) {
                    FHtml::saveFiles($files, $this->uploadFolder . '/object-file/');
                    FHtml::saveModel($modelMeta, $request->post(), ['object_file_id' => $model->id]);
                    FHtml::saveObjectItems($model, $this->moduleKey, $model->id, $model::getRelatedObjects());
                    if ($this->saveType() == 'clone') {
