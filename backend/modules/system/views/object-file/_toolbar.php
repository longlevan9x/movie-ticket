    ...
    $bulkActionButton = '<div class="dropdown pull-left">&nbsp;<button class="btn btn-default" data-toggle="dropdown">' . FHtml::t('common', 'Actions') . '</button>' . DropdownX::widget([
            'items' =>
                \yii\helpers\ArrayHelper::merge(
                    [FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set') . ' [' . FHtml::t('ObjectFile', 'Object Type') . ']:', 'object_file', 'object_file', 'object_type')],
                    [FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set') . ' [' . FHtml::t('ObjectFile', 'File Type') . ']:', 'object_file', 'object_file', 'file_type')],
                    [FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set') . ' [' . FHtml::t('ObjectFile', 'Is Active') . ']:', 'object_file', 'object_file', 'is_active')],
