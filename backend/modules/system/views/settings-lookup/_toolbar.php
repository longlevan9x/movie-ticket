...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    [FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('SettingsLookup', 'Object Type') . ']:', 'settings_lookup', 'settings_lookup', 'object_type')],
[FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('SettingsLookup', 'Is Cached') . ']:', 'settings_lookup', 'settings_lookup', 'is_cached')],
[FHtml::buildBulkActionsMenu(FHtml::t('common', 'Set'). ' ['. FHtml::t('SettingsLookup', 'Is Active') . ']:', 'settings_lookup', 'settings_lookup', 'is_active')],
