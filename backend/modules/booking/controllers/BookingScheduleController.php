...
use backend\modules\booking\models\BookingScheduleSearch;
...
/**
 * BookingScheduleController implements the CRUD actions for BookingSchedule model.
 */
class BookingScheduleController extends AdminController
{
    protected $moduleName = 'BookingSchedule';
    protected $moduleTitle = 'Booking Schedule';
    protected $moduleKey = 'booking_schedule';
    protected $object_type = 'booking_schedule';
...
/**
    ...
    /**
     * Lists all BookingSchedule models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new BookingScheduleSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = BookingSchedule::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['BookingSchedule']);
           $post['BookingSchedule'] = $posted;
    ...
    /**
     * Displays a single BookingSchedule model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new BookingSchedule model.
    ...
    /**
     * Updates an existing BookingSchedule model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing BookingSchedule model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing BookingSchedule model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the BookingSchedule model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BookingSchedule the loaded model
