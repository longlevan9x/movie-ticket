...
* This is the customized model class for table "BookingSeat".
*/
namespace backend\modules\booking\controllers;

use Yii;
use backend\modules\booking\models\BookingSeat;
use backend\modules\booking\models\BookingSeatSearch;
...
/**
 * BookingSeatController implements the CRUD actions for BookingSeat model.
 */
class BookingSeatController extends AdminController
{
    protected $moduleName = 'BookingSeat';
    protected $moduleTitle = 'Booking Seat';
    protected $moduleKey = 'booking_seat';
    protected $object_type = 'booking_seat';
...
/**
    ...
    /**
     * Lists all BookingSeat models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new BookingSeatSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = BookingSeat::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['BookingSeat']);
           $post['BookingSeat'] = $posted;
    ...
    /**
     * Displays a single BookingSeat model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new BookingSeat model.
    ...
    /**
     * Updates an existing BookingSeat model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing BookingSeat model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing BookingSeat model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the BookingSeat model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BookingSeat the loaded model
