...
/*
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'booking_seat', 'id','int(11)','booking-seat') . '</b>' ; }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: object_id, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model-> object_id, FHtml::SHOW_LABEL, 'booking_seat', 'object_id','varchar(100)','booking-seat'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        ...
        'filter'=> FHtml::getComboArray('booking_seat', 'booking_seat', 'object_id', true, 'id', 'name'),
    ],
    [ //name: object_type, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model-> object_type, FHtml::SHOW_LABEL, 'booking_seat', 'object_type','varchar(100)','booking-seat'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('booking_seat', 'booking_seat', 'object_type', true, 'id', 'name'),
    ],
    ...
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model-> type, FHtml::SHOW_LABEL, 'booking_seat', 'type','varchar(100)','booking-seat'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('booking_seat', 'booking_seat', 'type', true, 'id', 'name'),
    ],
    [ //name: status, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> status, FHtml::SHOW_LABEL, 'booking_seat', 'status','varchar(100)','booking-seat'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('booking_seat', 'booking_seat', 'status', true, 'id', 'name'),
    ],
    //[ //name: sort_order, dbType: tinyint(4), phpType: integer, size: 4, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> sort_order, FHtml::SHOW_NUMBER, 'booking_seat', 'sort_order','tinyint(4)','booking-seat'); }, 
        //'hAlign'=>'right',
        //'vAlign'=>'middle',
        //'width'=>'50px',
        //'editableOptions'=>[                       
    ...
    [ //name: is_active, dbType: tinyint(1), phpType: integer, size: 1, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model-> is_active, FHtml::SHOW_BOOLEAN, 'booking_seat', 'is_active','tinyint(1)','booking-seat'); }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'20px',
    ],
