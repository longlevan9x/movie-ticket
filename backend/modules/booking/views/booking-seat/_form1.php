    ...
    <div class="row">
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                               <?= $form->field($model, 'object_id')->select(FHtml::getComboArray('booking_seat', 'booking_seat', 'object_id', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'name')->textInput() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'object_type')->select(FHtml::getComboArray('booking_seat', 'booking_seat', 'object_type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'type')->select(FHtml::getComboArray('booking_seat', 'booking_seat', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'status')->select(FHtml::getComboArray('booking_seat', 'booking_seat', 'status', true, 'id', 'name'))->labelSpan(6) ?>
