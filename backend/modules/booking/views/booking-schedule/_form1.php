                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                               <?= $form->field($model, 'object_id')->select(FHtml::getComboArray('@cinema_movie', 'cinema_movie', 'object_id', true, 'id', 'name')) ?>

       <?= $form->field($model, 'date')->date() ?>

       <?= $form->field($model, 'start_time')->date() ?>

       <?= $form->field($model, 'finish_time')->date() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'object_type')->select(FHtml::getComboArray('booking_schedule', 'booking_schedule', 'object_type', true, 'id', 'name'))->labelSpan(6) ?>
