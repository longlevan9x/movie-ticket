...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'booking_schedule', 'booking_schedule', 'object_type'),
FHtml::buildBulkActionsMenu('', 'booking_schedule', 'booking_schedule', 'is_active'),
