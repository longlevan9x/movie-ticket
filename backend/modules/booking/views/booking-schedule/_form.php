                            ...
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                        ...
                                        'object_id' => ['value' => $form->fieldNoLabel($model, 'object_id')->select(FHtml::getComboArray('@cinema_movie', 'cinema_movie', 'object_id', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'date' => ['value' => $form->fieldNoLabel($model, 'date')->date(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'start_time' => ['value' => $form->fieldNoLabel($model, 'start_time')->date(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'finish_time' => ['value' => $form->fieldNoLabel($model, 'finish_time')->date(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
                                        ...
                                        -->
                                            ...
                                            'object_type' => ['value' => $form->fieldNoLabel($model, 'object_type')->select(FHtml::getComboArray('booking_schedule', 'booking_schedule', 'object_type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
