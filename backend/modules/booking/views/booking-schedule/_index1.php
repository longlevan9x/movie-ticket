...
/* @var $searchModel backend\modules\booking\models\BookingScheduleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$moduleName = isset($moduleName) ? $moduleName : 'BookingSchedule';
$moduleTitle = isset($moduleTitle) ? $moduleTitle : 'Booking Schedule';
$moduleKey = isset($moduleKey) ? $moduleKey : 'booking-schedule';
$object_type = isset($object_type) ? $object_type : 'booking_schedule';
...
<div class="row">
    <div class="col-md-10 col-xs-12">
        <div class="booking-schedule-index">
