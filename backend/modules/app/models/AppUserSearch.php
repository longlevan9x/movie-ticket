...
class AppUserSearch extends AppUser{
    ...
    public function rules()
    {
        return [
            ...
            [['avatar', 'name', 'username', 'email', 'password', 'auth_key', 'password_hash', 'password_reset_token', 'description', 'content', 'gender', 'dob', 'phone', 'weight', 'height', 'address', 'country', 'state', 'city', 'card_number', 'card_cvv', 'card_exp', 'lat', 'long', 'type', 'status', 'provider_id', 'created_date', 'modified_date'], 'safe'],
            [['balance', 'rate'], 'number'],
        ];
    }
