        ...
        if($request->isAjax){
            ...
            */
            ...
            if ($model->load($request->post())) {
                ...
                if ($model->save()) {
                    FHtml::saveModel($modelMeta, $request->post(), ['app_user_transaction_id' => $model->id]);

                    $files =FHtml::getUploadedFiles($model, $uploadFields, 'app-user-transaction' . FHtml::getAttribute($model, 'id'), $oldModel);

                    FHtml::saveFiles($files, $this->uploadFolder .  '/app-user-transaction/', $model);
        ...
        if($request->isAjax){
            ...
            */
            ...
            if ($model->load($request->post())) {
                ...
                if ($model->save()) {
                    FHtml::saveFiles($files, $this->uploadFolder .  '/app-user-transaction/');
                    FHtml::saveModel($modelMeta, $request->post(), ['app_user_transaction_id' => $model->id]);
                    FHtml::saveObjectItems($model, $this->moduleKey, $model->id, $model::getRelatedObjects());
                    if ($this->saveType() == 'clone')
                    {
