...
use backend\modules\app\models\AppUserDeviceSearch;
...
/**
 * AppUserDeviceController implements the CRUD actions for AppUserDevice model.
 */
class AppUserDeviceController extends AdminController
{
    protected $moduleName = 'AppUserDevice';
    protected $moduleTitle = 'App User Device';
    protected $moduleKey = 'app_user_device';
    protected $object_type = 'app_user_device';
...
/**
    ...
    /**
     * Lists all AppUserDevice models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new AppUserDeviceSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = AppUserDevice::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['AppUserDevice']);
           $post['AppUserDevice'] = $posted;
    ...
    /**
     * Displays a single AppUserDevice model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new AppUserDevice model.
    ...
    /**
     * Updates an existing AppUserDevice model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing AppUserDevice model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing AppUserDevice model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the AppUserDevice model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AppUserDevice the loaded model
