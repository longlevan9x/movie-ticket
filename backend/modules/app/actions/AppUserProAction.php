...
* This is the customized model class for table "backend\modules\app\models\AppUserPro".
*/
class AppUserProAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'app_user_pro';
        $this->objectname = 'app_user_pro';
