...
* This is the customized model class for table "backend\modules\app\models\AppUser".
*/
class AppUserAction extends BaseAction
{
    public function run()
    {
        $this->listname = 'app_user';
        $this->objectname = 'app_user';
