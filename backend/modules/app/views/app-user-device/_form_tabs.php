    ...
    <div class="row">
        <div class="profile-sidebar col-md-3">
            <div class="portlet light">
                ...
                <div class="margin-top-20">
                    <?= FHtml::showLabel('app_user_device.type', 'app_user_device', 'type', $model->type) ?>
                    <?= FHtml::showLabel('app_user_device.status', 'app_user_device', 'status', $model->status) ?>
                </div>
            ...
            <div class="portlet light">
                <div class="portlet-title tabbable-line">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#tab_1_5" data-toggle="tab"><?= FHtml::t('common', 'Gcm') ?></a>
                        </li>
                    </ul>
                </div>
                <div class="body">
