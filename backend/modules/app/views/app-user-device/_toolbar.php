...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'app_user_device', 'app_user_device', 'type'),
FHtml::buildBulkActionsMenu('', 'app_user_device', 'app_user_device', 'status'),
