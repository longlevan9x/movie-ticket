...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'gcm_id')->selectMany(FHtml::getComboArray('app_user_device', 'app_user_device', 'gcm_id', true, 'id', 'name')) ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->checkbox() ->labelSpan(6) ?>

       <?= $form->field($model, 'status')->checkbox() ->labelSpan(6) ?>
