...
/*
    ...
    [ //name: comment, dbType: varchar(4000), phpType: string, size: 4000, allowNull:  
        'class' => FHtml::getColumnClass($object_type, 'comment', $form_type),
        'format'=>'raw',
        'attribute'=>'comment',
        'visible' => FHtml::isVisibleInGrid($object_type, 'comment', $form_type),
        'hAlign'=>'left',
        'vAlign'=>'middle',
    ...
    [ //name: response, dbType: text, phpType: string, size: , allowNull: 1 
        'class' => FHtml::getColumnClass($object_type, 'response', $form_type),
        'format'=>'raw',
        'attribute'=>'response',
        'visible' => FHtml::isVisibleInGrid($object_type, 'response', $form_type),
