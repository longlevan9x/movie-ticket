...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'app_user_feedback', 'app_user_feedback', 'object_type'),
FHtml::buildBulkActionsMenu('', 'app_user_feedback', 'app_user_feedback', 'type'),
FHtml::buildBulkActionsMenu('', 'app_user_feedback', 'app_user_feedback', 'status'),
