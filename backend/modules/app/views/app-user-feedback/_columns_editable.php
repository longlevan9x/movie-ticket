...
return [
    ...
    [ //name: id, dbType: int(11), phpType: integer, size: 11, allowNull:  
        ...
        'value' => function($model) { return '<b>' . FHtml::showContent($model-> id, FHtml::SHOW_NUMBER, 'app_user_feedback', 'id','int(11)','app-user-feedback') . '</b>' ; }, 
        'hAlign'=>'center',
        'vAlign'=>'middle',
        'width'=>'50px',
    ],
    [ //name: user_id, dbType: varchar(100), phpType: string, size: 100, allowNull:  
        ...
        'value' => function($model) { return FHtml::showContent($model-> user_id, FHtml::SHOW_LOOKUP, '@app_user', 'user_id','varchar(100)','app-user-feedback'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
...
//        'value' => function($model) { return FHtml::showContent($model-> object_id, FHtml::SHOW_LABEL, 'app_user_feedback', 'object_id','varchar(100)','app-user-feedback'); },
//        'hAlign'=>'left',
//        'vAlign'=>'middle',
//        'width'=>'80px',
//        'filterType' => GridView::FILTER_SELECT2,
...
//                            ],
//        'filterInputOptions'=>['placeholder'=>''],
//        'filter'=> FHtml::getComboArray('app_user_feedback', 'app_user_feedback', 'object_id', true, 'id', 'name'),
//    ],
...
//        'value' => function($model) { return FHtml::showContent($model-> object_type, FHtml::SHOW_LABEL, 'app_user_feedback', 'object_type','varchar(100)','app-user-feedback'); },
//        'hAlign'=>'left',
//        'vAlign'=>'middle',
//        'width'=>'80px',
//        'filterType' => GridView::FILTER_SELECT2,
...
//                            ],
//        'filterInputOptions'=>['placeholder'=>''],
//        'filter'=> FHtml::getComboArray('app_user_feedback', 'app_user_feedback', 'object_type', true, 'id', 'name'),
//    ],
    [ //name: comment, dbType: varchar(4000), phpType: string, size: 4000, allowNull:  
        'class' => FHtml::getColumnClass($moduleName, 'comment', $form_type, true),
        'format'=>'raw',
        'attribute'=>'comment',
        'visible' => FHtml::isVisibleInGrid($moduleName, 'comment', $form_type, true),
        'hAlign'=>'left',
        'vAlign'=>'middle',
    ...
    [ //name: response, dbType: text, phpType: string, size: , allowNull: 1 
        'class' => FHtml::getColumnClass($moduleName, 'response', $form_type, true),
        'format'=>'raw',
        'attribute'=>'response',
        'visible' => FHtml::isVisibleInGrid($moduleName, 'response', $form_type, true),
        'value' => function($model) { return FHtml::showContent($model-> response, '', 'app_user_feedback', 'response','text','app-user-feedback'); }, 
        'hAlign'=>'right',
        'vAlign'=>'middle',
    ...
    [ //name: type, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> type, FHtml::SHOW_LABEL, 'app_user_feedback', 'type','varchar(100)','app-user-feedback'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('app_user_feedback', 'app_user_feedback', 'type', true, 'id', 'name'),
    ],
    [ //name: status, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        'value' => function($model) { return FHtml::showContent($model-> status, FHtml::SHOW_LABEL, 'app_user_feedback', 'status','varchar(100)','app-user-feedback'); }, 
        'hAlign'=>'left',
        'vAlign'=>'middle',
        'width'=>'80px',
        'filterType' => GridView::FILTER_SELECT2, 
        ...
        'filterInputOptions'=>['placeholder'=>''],
        'filter'=> FHtml::getComboArray('app_user_feedback', 'app_user_feedback', 'status', true, 'id', 'name'),
    ],
    ...
    //[ //name: created_user, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> created_user, FHtml::SHOW_LABEL, 'app_user_feedback', 'created_user','varchar(100)','app-user-feedback'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'80px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('app_user_feedback', 'app_user_feedback', 'created_user', true, 'id', 'name'),
    //],
    ...
    //[ //name: modified_user, dbType: varchar(100), phpType: string, size: 100, allowNull: 1 
        ...
        //'value' => function($model) { return FHtml::showContent($model-> modified_user, FHtml::SHOW_LABEL, 'app_user_feedback', 'modified_user','varchar(100)','app-user-feedback'); }, 
        //'hAlign'=>'left',
        //'vAlign'=>'middle',
        //'width'=>'80px',
        //'filterType' => GridView::FILTER_SELECT2, 
        //'filterWidgetOptions'=>[
                            ...
                            //],
        //'filterInputOptions'=>['placeholder'=>''],
        //'filter'=> FHtml::getComboArray('app_user_feedback', 'app_user_feedback', 'modified_user', true, 'id', 'name'),
    //],
    [
