    ...
    <div class="row">
        <div class="profile-sidebar col-md-3">
            <div class="portlet light">
                ...
                <div class="margin-top-20">
                    <?= FHtml::showLabel('app_user.gender', 'app_user', 'gender', $model->gender) ?>
<?= FHtml::showLabel('app_user.type', 'app_user', 'type', $model->type) ?>
<?= FHtml::showLabel('app_user.status', 'app_user', 'status', $model->status) ?>
                </div>
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#tab_1_4" data-toggle="tab"><?= FHtml::t('common', 'Group')?></a>
                                ...
                                <a href="#tab_1_5" data-toggle="tab"><?= FHtml::t('common', 'Password')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_6" data-toggle="tab"><?= FHtml::t('common', 'PERSONAL')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_7" data-toggle="tab"><?= FHtml::t('common', 'LOCATION')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_8" data-toggle="tab"><?= FHtml::t('common', 'FINANCE')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_9" data-toggle="tab"><?= FHtml::t('common', 'PAYMENT')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_10" data-toggle="tab"><?= FHtml::t('common', 'RATINGS')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_11" data-toggle="tab"><?= FHtml::t('common', 'GROUPING')?></a>
                                </li>
                            <li>
                                <a href="#tab_1_12" data-toggle="tab"><?= FHtml::t('common', 'Provider')?></a>
                                </li>
                             </ul>
                </div>
                <div class="body">
...
$form->field($model, 'role')->widget(\kartik\widgets\Select2::className(),['data' => FHtml::getComboArray('app_user', 'app_user', 'role', true, 'id', 'name'), 'options'=>['multiple' => false], 'pluginOptions' => ['allowClear' => true, 'tags' => true]]) ?>
                                                                                ...
                                                                                <div class="tab-pane row" id="tab_1_12">
                                            <div class="col-md-12">
