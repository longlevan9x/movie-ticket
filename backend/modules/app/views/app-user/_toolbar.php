...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'app_user', 'app_user', 'is_online'),
FHtml::buildBulkActionsMenu('', 'app_user', 'app_user', 'is_active'),
FHtml::buildBulkActionsMenu('', 'app_user', 'app_user', 'type'),
FHtml::buildBulkActionsMenu('', 'app_user', 'app_user', 'status'),
