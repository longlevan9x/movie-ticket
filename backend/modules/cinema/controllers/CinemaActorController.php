...
use backend\modules\cinema\models\CinemaActorSearch;
...
/**
 * CinemaActorController implements the CRUD actions for CinemaActor model.
 */
class CinemaActorController extends AdminController
{
    protected $moduleName = 'CinemaActor';
    protected $moduleTitle = 'Cinema Actor';
    protected $moduleKey = 'cinema_actor';
    protected $object_type = 'cinema_actor';
...
/**
    ...
    /**
     * Lists all CinemaActor models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CinemaActorSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CinemaActor::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CinemaActor']);
           $post['CinemaActor'] = $posted;
    ...
    /**
     * Displays a single CinemaActor model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CinemaActor model.
    ...
    /**
     * Updates an existing CinemaActor model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CinemaActor model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CinemaActor model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CinemaActor model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CinemaActor the loaded model
