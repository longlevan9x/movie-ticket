...
use backend\modules\cinema\models\CinemaShowSearch;
...
/**
 * CinemaShowController implements the CRUD actions for CinemaShow model.
 */
class CinemaShowController extends AdminController
{
    protected $moduleName = 'CinemaShow';
    protected $moduleTitle = 'Cinema Show';
    protected $moduleKey = 'cinema_show';
    protected $object_type = 'cinema_show';
...
/**
    ...
    /**
     * Lists all CinemaShow models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CinemaShowSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CinemaShow::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CinemaShow']);
           $post['CinemaShow'] = $posted;
    ...
    /**
     * Displays a single CinemaShow model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CinemaShow model.
    ...
    /**
     * Updates an existing CinemaShow model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CinemaShow model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CinemaShow model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CinemaShow model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CinemaShow the loaded model
