...
* This is the customized model class for table "CinemaHall".
*/
namespace backend\modules\cinema\controllers;

use Yii;
use backend\modules\cinema\models\CinemaHall;
use backend\modules\cinema\models\CinemaHallSearch;
 ...
 */
class CinemaHallController extends AdminController
{
    protected $moduleName = 'CinemaHall';
    protected $moduleTitle = 'Cinema Hall';
    protected $moduleKey = 'cinema_hall';
    protected $object_type = 'cinema_hall';
...
/**
    ...
    {    
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CinemaHall::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CinemaHall']);
           $post['CinemaHall'] = $posted;
    ...
    /**
     * Delete an existing CinemaHall model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CinemaHall model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
