...
use backend\modules\cinema\models\CinemaMovieSearch;
...
/**
 * CinemaMovieController implements the CRUD actions for CinemaMovie model.
 */
class CinemaMovieController extends AdminController
{
    protected $moduleName = 'CinemaMovie';
    protected $moduleTitle = 'Cinema Movie';
    protected $moduleKey = 'cinema_movie';
    protected $object_type = 'cinema_movie';
...
/**
    ...
    /**
     * Lists all CinemaMovie models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CinemaMovieSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CinemaMovie::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CinemaMovie']);
           $post['CinemaMovie'] = $posted;
    ...
    /**
     * Displays a single CinemaMovie model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CinemaMovie model.
    ...
    /**
     * Updates an existing CinemaMovie model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CinemaMovie model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CinemaMovie model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
    ...
    /**
     * Finds the CinemaMovie model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return CinemaMovie the loaded model
