...
use backend\modules\cinema\models\CinemaSearch;
...
class CinemaController extends AdminController
{
    ...
    protected $moduleTitle = 'Cinema';
    protected $moduleKey = 'cinema';
    protected $object_type = 'cinema';
...
/**
    ...
    /**
     * Delete an existing Cinema model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Cinema model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
