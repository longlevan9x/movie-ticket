...
* This is the customized model class for table "CinemaBrand".
*/
namespace backend\modules\cinema\controllers;

use Yii;
use backend\modules\cinema\models\CinemaBrand;
use backend\modules\cinema\models\CinemaBrandSearch;
...
/**
 * CinemaBrandController implements the CRUD actions for CinemaBrand model.
 */
class CinemaBrandController extends AdminController
{
    protected $moduleName = 'CinemaBrand';
    protected $moduleTitle = 'Cinema Brand';
    protected $moduleKey = 'cinema_brand';
    protected $object_type = 'cinema_brand';
...
/**
    ...
    /**
     * Lists all CinemaBrand models.
     * @return mixed
     */
    public function actionIndex()
    {    
              $searchModel = new CinemaBrandSearch();
       ...
       if (Yii::$app->request->post('hasEditable')) {
           ...
           $model = CinemaBrand::findOne($Id);

           $out = Json::encode(['output' => '', 'message' => '']);

           $post = [];
           $posted = current($_POST['CinemaBrand']);
           $post['CinemaBrand'] = $posted;
    ...
    /**
     * Displays a single CinemaBrand model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CinemaBrand model.
    ...
    /**
     * Updates an existing CinemaBrand model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing CinemaBrand model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing CinemaBrand model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the CinemaBrand model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CinemaBrand the loaded model
