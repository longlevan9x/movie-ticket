...
$moduleName = 'CinemaHall';
$moduleTitle = 'Cinema Hall';
$moduleKey = 'cinema-hall';
...
/* @var $model backend\modules\cinema\models\CinemaHall */
...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'seat_count')->numeric() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'status')->select(FHtml::getComboArray('cinema_hall', 'cinema_hall', 'status', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'type')->select(FHtml::getComboArray('cinema_hall', 'cinema_hall', 'type', true, 'id', 'name'))->labelSpan(6) ?>
