    ...
    <div class="row">
       ...
       <?= $form->field($model, 'email')->emailInput() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('cinema_brand', 'cinema_brand', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'status')->select(FHtml::getComboArray('cinema_brand', 'cinema_brand', 'status', true, 'id', 'name'))->labelSpan(6) ?>
