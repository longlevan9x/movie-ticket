...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cinema_actor', 'cinema_actor', 'type'),
FHtml::buildBulkActionsMenu('', 'cinema_actor', 'cinema_actor', 'is_active'),
FHtml::buildBulkActionsMenu('', 'cinema_actor', 'cinema_actor', 'status'),
