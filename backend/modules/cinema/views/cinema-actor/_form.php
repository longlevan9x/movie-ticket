...
'country'     => ['value' => $form->fieldNoLabel($model, 'country')->select(FHtml::getComboArray('cinema_actor', 'cinema_actor', 'country', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'dob'         => ['value' => $form->fieldNoLabel($model, 'dob')->date(), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'gender'      => ['value' => $form->fieldNoLabel($model, 'gender')->select(FHtml::getComboArray('cinema_actor', 'cinema_actor', 'gender', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
...
'type'      => ['value' => $form->fieldNoLabel($model, 'type')->select(FHtml::getComboArray('cinema_actor', 'cinema_actor', 'type', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
'status'    => ['value' => $form->fieldNoLabel($model, 'status')->selectMany(FHtml::getComboArray('cinema_actor', 'cinema_actor', 'status', true, 'id', 'name')), 'columnOptions' => ['colspan' => 1], 'type' => FHtml::INPUT_RAW],
