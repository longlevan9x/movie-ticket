...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'country')->select(FHtml::getComboArray('cinema_actor', 'cinema_actor', 'country', true, 'id', 'name')) ?>

       <?= $form->field($model, 'dob')->date() ?>

       <?= $form->field($model, 'gender')->select(FHtml::getComboArray('cinema_actor', 'cinema_actor', 'gender', true, 'id', 'name')) ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('cinema_actor', 'cinema_actor', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'status')->selectMany(FHtml::getComboArray('cinema_actor', 'cinema_actor', 'status', true, 'id', 'name'))->labelSpan(6) ?>
