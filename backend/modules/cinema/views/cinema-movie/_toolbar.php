...
if (FHtml::isInRole('', 'action', $currentRole))
{
    ...
    FHtml::buildBulkActionsMenu('', 'cinema_movie', 'cinema_movie', 'status'),
FHtml::buildBulkActionsMenu('', 'cinema_movie', 'cinema_movie', 'type'),
FHtml::buildBulkActionsMenu('', 'cinema_movie', 'cinema_movie', 'is_active'),
