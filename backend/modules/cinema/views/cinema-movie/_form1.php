...
<div class="form">
    <div class="row">
       ...
       <?= $form->field($model, 'director')->select(FHtml::getComboArray('cinema_movie', 'cinema_movie', 'director', true, 'id', 'name')) ?>

       <?= $form->field($model, 'writer')->select(FHtml::getComboArray('cinema_movie', 'cinema_movie', 'writer', true, 'id', 'name')) ?>

       <?= $form->field($model, 'runtime')->date() ?>

       <?= $form->field($model, 'trailer')->textInput() ?>

       <?= $form->field($model, 'technology')->select(FHtml::getComboArray('cinema_movie', 'cinema_movie', 'technology', true, 'id', 'name')) ?>

       <?= $form->field($model, 'mpaa')->select(FHtml::getComboArray('cinema_movie', 'cinema_movie', 'mpaa', true, 'id', 'name')) ?>

       <?= $form->field($model, 'country')->select(FHtml::getComboArray('cinema_movie', 'cinema_movie', 'country', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'close_date')->date() ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'status')->select(FHtml::getComboArray('cinema_movie', 'cinema_movie', 'status', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'type')->select(FHtml::getComboArray('cinema_movie', 'cinema_movie', 'type', true, 'id', 'name'))->labelSpan(6) ?>
