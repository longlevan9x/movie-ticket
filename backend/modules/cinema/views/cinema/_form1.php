...
<div class="form">
    <div class="row">
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active row" id="tab_1_1">
                                    <div class="col-md-12">
                                               <?= $form->field($model, 'brand_id')->select(FHtml::getComboArray('cinema', 'cinema', 'brand_id', true, 'id', 'name')) ?>
       ...
       <?= $form->field($model, 'city')->select(FHtml::getComboArray('cinema', 'cinema', 'city', true, 'id', 'name')) ?>

       <?= $form->field($model, 'country')->select(FHtml::getComboArray('cinema', 'cinema', 'country', true, 'id', 'name')) ?>
                                        ...
                                        -->
                                            ...
                                            <div class="col-md-6">
                                               <?= $form->field($model, 'type')->select(FHtml::getComboArray('cinema', 'cinema', 'type', true, 'id', 'name'))->labelSpan(6) ?>

       <?= $form->field($model, 'status')->select(FHtml::getComboArray('cinema', 'cinema', 'status', true, 'id', 'name'))->labelSpan(6) ?>
