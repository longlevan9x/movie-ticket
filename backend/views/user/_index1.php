...
$moduleName = isset($moduleName) ? $moduleName : 'User';
$moduleTitle = isset($moduleTitle) ? $moduleTitle : 'User';
$moduleKey = isset($moduleKey) ? $moduleKey : 'user';
$object_type = isset($object_type) ? $object_type : 'user';
