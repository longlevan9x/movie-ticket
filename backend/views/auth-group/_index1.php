...
$moduleName = isset($moduleName) ? $moduleName : 'AuthGroup';
$moduleTitle = isset($moduleTitle) ? $moduleTitle : 'Auth Group';
$moduleKey = isset($moduleKey) ? $moduleKey : 'auth-group';
$object_type = isset($object_type) ? $object_type : 'auth_group';
