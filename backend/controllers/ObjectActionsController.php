 ...
 */
class ObjectActionsController extends AdminController
{
    protected $moduleName = 'ObjectActions';
    protected $moduleTitle = 'Object Actions';
...
/**
    ...
    /**
     * Creates a new ObjectActions model.
    ...
    /**
     * Updates an existing ObjectActions model.
     * For ajax request will return json object
    ...
    /**
     * Finds the ObjectActions model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return ObjectActions the loaded model
