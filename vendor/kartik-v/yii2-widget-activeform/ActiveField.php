...
class ActiveField extends \yii\widgets\ActiveField
{
    ...
    public function lookup($object_type, $options = [], $populated_fields = [], $search_field = 'name', $id_field = 'id', $class = FHtml::EDITOR_SELECT) {
        ...
        return self::select(null, $options, $object_type, $populated_fields, $search_field, $id_field, $class);
    }
    ...
    public function date($format = 'yyyy-mm-dd', $options = [], $disabled_date = '0,6', $disabled_hours = '0, 1', $class = FHtml::EDITOR_DATE)
    {
        $options = array_merge($this->inputOptions, $options);
        $this->adjustLabelFor($options);
        /* @var $class \yii\base\Widget */
    ...
    public function datetime($format = 'yyyy-mm-dd hh:ii', $options = [], $disabled_date = '0,6', $disabled_hours = '0, 1',  $class = FHtml::EDITOR_DATETIME)
    {
        return self::date($format, $options, $disabled_date, $disabled_hours, $class);
    }

    public function html($options = ['rows' => 5, 'disabled' => false], $preset = 'normal', $class = FHtml::EDITOR_HTML)
    {
        $options = array_merge($this->inputOptions, $options);
        $this->adjustLabelFor($options);
        /* @var $class \yii\base\Widget */
    ...
    public function fckeditor($options = ['rows' => 5, 'disabled' => false], $preset = 'normal', $class = FHtml::EDITOR_HTML)
    {
    ...
    public function numeric($options = [], $autoGroup = true, $class = FHtml::EDITOR_NUMERIC)
    {
        $options = array_merge($options, ['clientOptions' => ['alias' =>  'numeric', 'groupSeparator' => FHtml::settingThousandSeparatorFormat(), 'autoGroup' => $autoGroup, 'removeMaskOnSubmit' => true]]);

        return self::widget($class, $options);
    }

    public function numericInput($options = [], $autoGroup = true, $class = FHtml::EDITOR_NUMERIC)
    {
        return self::numeric($options, $class);
    }
    ...
    public function currency($prefix = '', $options = [], $class = FHtml::EDITOR_NUMERIC)
    {
        ...
        $options = array_merge($options, ['clientOptions' => ['prefix' => $prefix . ' ', 'alias' =>  'currency', 'groupSeparator' => FHtml::settingThousandSeparatorFormat(), 'autoGroup' => true, 'removeMaskOnSubmit' => true]]);
        return self::widget($class, $options);
    }
    ...
    public function emailInput($options = [], $class = FHtml::EDITOR_NUMERIC)
    {
        ...
        return self::textInput($options, $class);
    }
